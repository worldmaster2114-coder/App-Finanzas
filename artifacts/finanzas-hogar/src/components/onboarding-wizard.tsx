...
import { Sparkles, Target, Users, User as UserIcon, Check, KeyRound, Wallet, ArrowRight, ShieldCheck, HeartHandshake, TrendingUp } from 'lucide-react';
...
export function OnboardingWizard({ isOpen, initialUser, onComplete }: OnboardingWizardProps) {
